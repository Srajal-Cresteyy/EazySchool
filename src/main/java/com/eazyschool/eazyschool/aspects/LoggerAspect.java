package com.eazyschool.eazyschool.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.eazyschool.eazyschool..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.eazyschool.eazyschool.*.*(..))",throwing = "ex")
