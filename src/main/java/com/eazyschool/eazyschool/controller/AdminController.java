...
import com.eazyschool.eazyschool.model.EazyClass;
import com.eazyschool.eazyschool.model.Person;
import com.eazyschool.eazyschool.repository.CoursesRepository;
import com.eazyschool.eazyschool.repository.EazyClassRepository;
...
public class AdminController {
    ...
    @GetMapping("/deleteStudentFromCourse") //  Didn't use the Delete Mapping because we are not hard deleting anything from the DB were just breaking
    // the association                      //  the relationship between the two entities
